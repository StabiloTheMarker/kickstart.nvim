...
require('lazy').setup({
  ...
  -- NOTE: Telescope removed — using snacks.picker instead (see lua/custom/plugins/init.lua)
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- LSP navigation keymaps are defined in snacks.nvim picker config
          -- (see lua/custom/plugins/init.lua)
